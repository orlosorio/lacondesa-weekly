      ...
      <main className="pt-20 lg:pt-24 min-h-screen bg-background">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Thanks, {name.trim() || "you"}. We&apos;ll get back to you soon.
          </p>
        </div>
      </main>
    );
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <header className="mb-12">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-2xl">
            Readers, advertisers, collaborators — all welcome. We read and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div>
            ...
            <div className="space-y-6">
              ...
              <div
                className="opacity-0 h-0 w-0 overflow-hidden absolute pointer-events-none"
                aria-hidden
              >
          ...
          <div className="lg:pl-8 border-t lg:border-t-0 lg:border-l border-border pt-8 lg:pt-0">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We&apos;re a neighborhood publication focused on La Condesa. If you
              have something to share — a new place, a correction, an idea for a
              story or a collaboration — write to us. No bots: a person reads
              every message.
            </p>
          </div>
        </div>
